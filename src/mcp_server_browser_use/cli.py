...
async def _run_documentation_logic_cli(topic_str: str, current_settings: AppSettings) -> str:
    ...
    "- Use documentation actions when appropriate: doc_search, doc_orient_and_extract, click_best_doc_result, open_java_api_index, open_javadoc_io_search, identify_doc_profile, fetch_doc_sections_auto, extract_main_content, fetch_java_doc_sections, scroll_down, collect_doc_overview, open_anchor_by_text.\n"
    ...
    "- After landing on a doc page: scroll 2–3 times (scroll_down) to reveal content; then run identify_doc_profile.\n"
